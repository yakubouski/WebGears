<?php
class LayoutTabs extends \Html\Widget {
...
?>
<header class="layout-tabs <?= $class ?>" id="<?= $id ?>" >
    <ul class="layout-tab-items"  style="<?=$style?>" >
...
<section class="layout-tab-content">
	<?=implode(PHP_EOL,$tabItems)?>
</section>
<script type="text/javascript">UI.Widget('LayoutTabs','#<?=$id?>',{selected:'<?=$selected?>'})</script>
<?
    }
}
