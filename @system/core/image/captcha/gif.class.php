...
/*///////////////////////////////////////////////*/
/*//                                           //*/
/*//     G I F M E R G E. C L A S S . P H P    //*/
/*//                                           //*/
/*///////////////////////////////////////////////*/
/*
   ...
   lett.
   Szabadon haszn�lhat� ingyenes �s kereskedelmi jelleg�
   oldalakon, valamint publik�lhat� �s terjeszthet�, de
   a forr�sk�d nem m�dos�that� a szerz� beleegyez�se n�lk�l.
   ...
   =======================================================
         Constructor:
         *GifMerge(array A_IMAGES, int T_RED, int T_GREEN,
         				int T_BLUE, int A_LOOP, array F_DELAY, int A_DISPOSAL, array A_XPOS, array A_YPOS, string F_MODE)
         F_MODE: C_FILE (source frames indicated relative image paths)
                 C_MEMORY (source frames indicated direct binary streams)
*/
class GifMerge
{
	/*///////////////////////////////////////////////*/
	...
	/*//               A R R A Y S                 //*/
	/*///////////////////////////////////////////////*/
	var $gif							= array(0x47, 0x49, 0x46); // <= GIF
	var $buffer							= array();
	var $local_in						= array();
	var $global_in						= array();
	...
	function __construct($images, $t1, $t2, $t3, $loop, $dl, $dp, $xpos, $ypos, $model)
	{
		...
		if($loop)
		{
			$this->netscape[16] = $loop & 255;
    		$this->netscape[17] = $loop >> 8;
			$this->use_loop = true;
    	}
		if($t1 && $t2 && $t3)
		{
		...
		$this->fout .= "\x3b"; // Closing gif file
	}
	/*///////////////////////////////////////////////*/
	/*//    Function :: start_gifmerge_process()   //*/
	/*///////////////////////////////////////////////*/
	...
	function read_image_descriptor()
	{
		...
		{
			for ($i = 0; $i < $outsize; $i++)
				if (   $outtable [3 * $i	] == $this->trans1
					&& $outtable [3 * $i + 1] == $this->trans2
					&& $outtable [3 * $i + 2] == $this->trans3
				)
					break;
			if ($i < $outsize)
			{
